...
# Remove option to continue printing counterexamples.
sed 's/.*stopAfterError.*//' $SCRIPT_DIR/experiments/experiment900.xml > $SCRIPT_DIR/experiments/experiment900_one_cex.xml
...
--limitCores 1 ../experiments/experiment900_one_cex.xml
# Should be only one.
