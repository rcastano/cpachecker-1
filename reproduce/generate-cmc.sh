...
./scripts/cpa.sh -outputpath $DIRNAME -logfile logfile.txt  -preprocess -config test-configs/components/predicateAnalysis-generate-cmc-condition.properties $file
